...
function viewStudentStats(id, toggle)
{
	...
	if(toggle == 0)
	{
		...
		//style.visability = "hidden/"visable"
	}
...
{
	//var backround = document.getElementById("jumbotron")
...
function switchPlayers(playerNum)
{
	...
	//document.getElementById("player_selector").innerHTML = players[playerNum];
	document.getElementById("p_year").innerHTML = players[1].p_year;
